...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  // Determine if the custom cursor should be enabled (desktop, fine pointer)
  useEffect(() => {
    ...
    window.addEventListener("resize", mqHandler, { passive: true } as any);
    ...
    return () => {
      ...
      window.removeEventListener("resize", mqHandler as any);
    };
  }, []);
